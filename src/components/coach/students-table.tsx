...
import { MoreHorizontal, Edit, Trash2, Shuffle, User, Calendar, Layers, Eye } from "lucide-react";
...
export function StudentsTable({ students, stadiumId, coachId, refreshStudents }: StudentsTableProps) {
  ...
  const StudentActions = ({ student }: { student: Student }) => (
     <DropdownMenu>
        ...
        <DropdownMenuContent align="end">
            ...
            <EditStudentDialog student={student} stadiumId={stadiumId} onStudentUpdated={refreshStudents}>
                <DropdownMenuItem onSelect={(e) => e.preventDefault()}>
                    <Edit className="mr-2 size-4" /> Edit Details
                </DropdownMenuItem>
            </EditStudentDialog>
            <ChangeBatchDialog student={student} stadiumId={stadiumId} coachId={coachId} onBatchChanged={refreshStudents}>
                <DropdownMenuItem onSelect={(e) => e.preventDefault()}>
                    <Shuffle className="mr-2 size-4" /> Change Batch
                </DropdownMenuItem>
            </ChangeBatchDialog>
            <DropdownMenuSeparator />
            <DeleteStudentDialog studentId={student.id} studentName={student.fullName} stadiumId={stadiumId} onStudentDeleted={refreshStudents}>
