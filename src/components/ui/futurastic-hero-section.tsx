    ...
    >
      <div className="relative z-10 flex flex-col items-center">
        ...
        <h1 className="max-w-4xl bg-gradient-to-br from-white to-gray-400 bg-clip-text text-center text-3xl font-medium leading-tight text-transparent sm:text-5xl sm:leading-tight md:text-7xl md:leading-tight">
          Command Your Court with Unparalleled Precision
        </h1>
        <p className="my-6 max-w-xl text-center text-base leading-relaxed md:text-lg md:leading-relaxed">
         The ultimate all-in-one solution for managing your sports academy. Streamline operations, track performance, and unlock your academy's potential.
        </p>
        <motion.button
          style={{
            border,
